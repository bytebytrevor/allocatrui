          ...
          <div className="flex min-w-0 items-center gap-2.5 sm:gap-3.5 lg:gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              {/* ===============================================
                  ...
                  Mobile:
                  rating star only when rated

                  sm:
                  rating / New + experience

                  lg:
                  rating / New + experience + completed + location
              =============================================== */}
...
function ListRating({
  ...
  /*
    Unrated profiles:
    - hidden on the tightest mobile list
    - visible from sm upward as "New"

    Rated profiles:
    - star remains visible on mobile
    - numeric rating appears from sm
    - "rating" label appears from lg
  */
