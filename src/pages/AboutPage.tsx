...
//     icon: CompassIcon,
//     accent: "bg-sky-300/25 text-sky-700",
//   },
//   {
//     title: "Trust",
//     description:
...
//     accent: "bg-emerald-300/25 text-emerald-700",
//   },
//   {
//     title: "Momentum",
//     description:
...
//     icon: ZapIcon,
//     accent: "bg-amber-300/30 text-amber-700",
//   },
//   {
//     title: "Respect",
//     description:
...
//     accent: "bg-pink-300/25 text-pink-700",
//   },
// ];
...
//           <div className="relative overflow-hidden rounded-[1.75rem] bg-foreground px-5 py-12 text-background sm:rounded-[2.5rem] sm:px-8 sm:py-16 md:px-12 md:py-20 lg:px-20 lg:py-24">
...
//               <div className="min-w-0">
//                 <p className="mb-4 text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-background/55 sm:text-xs">
//                   What is an Allocat?
//                 </p>
...
//                 <p className="mt-6 max-w-3xl text-sm leading-7 text-background/70 sm:text-base sm:leading-8">
...
//             <div className="mt-12 grid border-y md:mt-16 md:grid-cols-3">
...
//                         index % 2 === 0
//                           ? "bg-emerald-300/25 text-emerald-700"
//                           : "bg-sky-300/25 text-sky-700",
//                       ].join(" ")}
//                     >
...
//             <motion.aside
//               className="relative min-w-0 overflow-hidden rounded-[2rem] border bg-background p-7 sm:p-9 md:p-12"
//               initial={{ opacity: 0, y: 35 }}
//               whileInView={{ opacity: 1, y: 0 }}
//               viewport={{ once: true }}
//               transition={{ duration: 0.65 }}
//             >
//               <div className="absolute right-0 top-0 h-28 w-28 rounded-bl-[5rem] bg-amber-300/25" />
...
//         {/* Values */}
//         <section className="bg-white py-16 text-[#151515] sm:py-20 md:py-24 lg:py-36">
...
//                   <motion.article
//                     key={value.title}
//                     className="flex min-h-[260px] min-w-0 flex-col justify-between rounded-[1.75rem] border border-[#151515]/10 p-6 sm:min-h-[300px] sm:rounded-[2rem] sm:p-8"
//                     initial={{ opacity: 0, y: 28 }}
//                     whileInView={{ opacity: 1, y: 0 }}
...
//                       <p className="mt-4 max-w-xl text-sm leading-7 text-[#151515]/60 sm:text-base">
//                         {value.description}
//                       </p>
//                     </div>
//                   </motion.article>
...
//           <div className="container mx-auto px-5 md:px-8">
//             <div className="overflow-hidden rounded-[2rem] bg-[#151515] px-6 py-12 text-white sm:px-8 sm:py-16 md:px-12 md:py-20 lg:px-16">
...
//                       <motion.article
//                         key={step.title}
//                         className="flex min-h-[230px] min-w-0 flex-col justify-between rounded-[1.5rem] border border-white/10 bg-white/[0.04] p-6"
...
//             <motion.article
//               className="relative min-h-[360px] overflow-hidden rounded-[2rem] border bg-background p-7 sm:p-10"
//               initial={{ opacity: 0, x: -30 }}
//               whileInView={{ opacity: 1, x: 0 }}
//               viewport={{ once: true }}
//               transition={{ duration: 0.6 }}
//             >
//               <div className="absolute right-0 top-0 h-36 w-36 rounded-bl-[7rem] bg-sky-300/20" />

//               <BriefcaseBusinessIcon size={30} className="relative text-sky-600" />
...
//               transition={{ duration: 0.6 }}
//             >
//               <div className="absolute right-0 top-0 h-36 w-36 rounded-bl-[7rem] bg-emerald-300/20" />

//               <SparklesIcon size={30} className="relative text-emerald-600" />
...
//           <div className="container mx-auto overflow-hidden rounded-[1.75rem] bg-primary px-5 py-12 sm:rounded-[2.5rem] sm:px-8 sm:py-16 md:px-12 md:py-20 lg:px-20 lg:py-24">
...
//                 <Button
//                   size="lg"
//                   className="h-[52px] w-full rounded-full bg-[#151515] px-8 text-white shadow-none hover:bg-[#151515]/90 sm:w-auto"
//                 >
//                   Post a job
...
//                   size="lg"
//                   variant="outline"
//                   className="h-[52px] w-full rounded-full border-[#151515]/20 bg-transparent px-8 text-[#151515] shadow-none hover:bg-white/30 sm:w-auto"
//                 >
//                   Become an Allocat
//                 </Button>
//               </div>
        ...
        {/* <footer className="bg-background px-5 py-8 text-foreground transition-colors sm:py-10 md:px-8">
          <div className="container mx-auto flex flex-col gap-6 border-t border-border pt-8 text-sm md:flex-row md:items-center md:justify-between">
            ...
            <nav className="flex flex-wrap gap-x-5 gap-y-3 sm:gap-x-6">
              ...
              <Link to="/about" className="font-semibold text-foreground">
                About
              </Link>
